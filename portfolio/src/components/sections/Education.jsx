    ...
    >
      ...
      <div className="tracking-wider text-center md:mx-10 border rounded-lg px-5 py-5 lg:py-10 lg:px-10">
        ...
        <p>
          ...
          alongside proficiency in Data Structures and Algorithms (DSA). This
          disciplined approach has enabled the delivery of functional solutions
          while strengthening problem-solving abilities and technical
          versatility in a structured, results-driven manner.
        </p>
      </div>
      ...
      <div className="tracking-wider text-center md:mx-10 border rounded-lg mt-20 px-5 py-5 lg:py-10 lg:px-10">
        ...
        <p>
          ...
          optimizing returns during periods of high volatility, fear, and greed.
          Proficient in dynamic risk mitigation, trend exploitation, and
          sustaining performance in hyper-competitive crypto environments.
        </p>
      </div>
      ...
      <div className="experience tracking-wider text-center md:mx-10 border rounded-lg mt-20 px-5 py-5 lg:py-10 lg:px-10">
        ...
        <p>
          Completed{" "}
          <span className="text-white bg-black px-2">1200+ hours</span> of
          intensive training in modern web development, mastering frontend and
          backend technologies to build scalable, real-world applications.
          Proficient in end-to-end development, agile methodologies, and
          collaborative project execution aligned with industry standards.
        </p>
      </div>
      ...
      <div className="experience tracking-wider text-center md:mx-10 border rounded-lg mt-20 px-5 py-5 lg:py-10 lg:px-10">
        ...
        <p>
          Enrolled in a Bachelor of Arts program in English Literature after
          completing high school. Spent two years enhancing writing and
          communication skills before making a strategic decision to transition
          into the IT industry. Developed strong proficiency in both written and
          spoken English, which now contributes to effective communication in a
